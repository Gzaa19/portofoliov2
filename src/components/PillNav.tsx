...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="fixed top-4 left-0 right-0 w-full flex justify-center z-[1000] pointer-events-none">
      <nav
        className={`w-full md:w-max flex items-center justify-between md:justify-start box-border px-4 md:px-0 pointer-events-auto ${className}`}
        aria-label="Primary"
        style={cssVars}
      >
